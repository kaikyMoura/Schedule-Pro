    ...
    return (
        <div className="mt-4 w-full max-w-md mx-auto flex flex-col justify-center">
            <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-800">SchedulePro</h1>
                <p className="text-gray-500 mt-2">Manage your appointments with ease</p>
            </div>
                ...
                <div className="p-8">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <a href="#" className="social-btn w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-md font-medium text-gray-700 hover:bg-gray-50 transition-all duration-150">
            ...
            {/* <div className="mt-8 text-center">
                ...
                <div className="flex justify-center space-x-3">
                    <a href="#" className="inline-flex items-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
