                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    <select className="block appearance-none cursor-pointer w-full bg-gray-50 border border-gray-200 text-gray-700 py-2 px-3 pr-8 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {availableTime.map((time, index) => (
                                        <button key={index} type="button"
                                            className={`py-2 px-3 text-sm rounded-md border border-gray-200 text-gray-700 hover:border-blue-300 focus:outline-none ${time === selectedTime ? "bg-blue-500 text-white" : ""}`}
                            ...
                            <div>
                                ...
                                <textarea className="block w-full bg-gray-50 border border-gray-200 text-gray-700 py-2 px-3 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="bg-gray-50 p-6 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-4 rounded-md border border-gray-200">
                            ...
                            <p className="text-gray-800">{selectedService?.type}</p>
                        ...
                        <div className="bg-white p-4 rounded-md border border-gray-200">
                            ...
                            <p className="text-gray-800">{dayjs(selectedDate).format('dddd, MMMM D, YYYY')}</p>
                            <p className="text-sm text-gray-500">{start.format('h:mm A')} - {end.format('h:mm A')}</p>
                        </div>
                        <div className="bg-white p-4 rounded-md border border-gray-200">
                            <h4 className="text-sm font-medium text-gray-500 mb-2">Staff</h4>
                            <p className="text-gray-800">{selectedStaff}</p>
                        </div>
                        <div className="bg-white p-4 rounded-md border border-gray-200">
                            <h4 className="text-sm font-medium text-gray-500 mb-2">Price</h4>
                            <p className="text-2xl font-semibold text-gray-800">${selectedService?.price}</p>
